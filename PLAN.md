...
**Sub-tasks**:
- [ ] 0.1 - Next.js 14+ 프로젝트 생성 (`create-next-app`)
- [ ] 0.2 - TypeScript 설정 확인
- [ ] 0.3 - shadcn/ui 설치 및 초기화
- [ ] 0.4 - Tailwind CSS 설정 확인
- [ ] 0.5 - 폴더 구조 생성 (components, lib, types)
- [ ] 0.6 - `data/` 폴더 생성 및 샘플 일지 파일 3-5개 복사
- [ ] 0.7 - 기본 레이아웃 설정 (layout.tsx)
...
**Sub-tasks**:
- [ ] 1.1 - JournalEntry 타입 정의
- [ ] 1.2 - 마크다운 파일명 → 날짜 파싱 유틸리티
- [ ] 1.3 - 섹션별 파싱 로직 구현
  - `# 1. 9 to 6 할 일` 섹션
  - `# 2. 6시 이후 하려는 일` 섹션 (🔥 표시 조건)
  - `# 3. 노트` 섹션
  - `# 4. 회고` 섹션
- [ ] 1.4 - `hasAfterSixContent` 플래그 계산 로직
- [ ] 1.5 - 파싱 함수 단위 테스트 작성
